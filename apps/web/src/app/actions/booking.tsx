...
export async function createBookingRequest(formData: FormData) {
  ...
  // Demo mode: demo service IDs are not in the DB — simulate success
  if (!bookingRequest.serviceId || bookingRequest.serviceId.startsWith("demo-")) {
  ...
  try {
    ...
    // Email is non-critical — don't block the confirmation
  }
