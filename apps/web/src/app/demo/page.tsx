...
const DEMOS: DemoCardData[] = [
  {
    slug: "booking",
    label: "ZenSlot",
    type: "Plateforme de reservation pro",
    tagline: "Dashboard admin, calendrier, services, clients, paiements et rappels. Une demo booking pro complete inspiree de ZenSlot.",
    result: "Lancez une plateforme de reservation B2B complete avec CRM client integre.",
    accent: "#4d7c0f",
    bg: "#fefce8",
    fg: "#292524",
    heroFrom: "#14532d",
    layout: "standard",
    complexity: "Advanced",
    keyComponents: ["BookingKpiGrid", "TodaysAppointmentsList", "CalendarDayView", "ServiceManagementTable", "ClientDirectoryTable", "WaitlistPanel"],
    integrations: ["Stripe", "Google Calendar", "Twilio SMS", "Zoom", "Mailchimp"],
  },
  {
    slug: "saas",
    label: "SaaS",
