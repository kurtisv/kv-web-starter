...
const DEMOS: DemoCardData[] = [
  ...
  },
  {
    ...
    label: "SaaS",
    type: "Produit SaaS",
    tagline: "Abonnements, metriques, quotas d'usage et tableau de bord client. Pret pour Stripe.",
    result: "Lancez un SaaS avec billing en quelques jours.",
    accent: "#7c3aed",
    bg: "#ffffff",
    fg: "#0f172a",
    heroFrom: "#4c1d95",
    layout: "standard",
    complexity: "Advanced",
    keyComponents: ["SubscriptionStatusCard", "UsageQuotaCard", "PlanComparisonTable", "MetricCard", "PricingSection"],
    integrations: ["Stripe", "Resend", "Upstash"],
  },
  {
    slug: "api",
    label: "API Portal",
