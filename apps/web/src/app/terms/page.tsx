...
export const metadata: Metadata = {
  ...
  description: "Conditions generales d'utilisation du service KV Web Starter.",
};
    ...
    <MarketingPageShell>
      <Section className="max-w-3xl">
        ...
        <div className="prose prose-sm mt-10 max-w-none text-foreground [&_h2]:mt-10 [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mt-6 [&_h3]:text-base [&_h3]:font-medium [&_p]:mt-4 [&_p]:leading-7 [&_p]:text-muted-foreground [&_ul]:mt-4 [&_ul]:grid [&_ul]:gap-1.5 [&_li]:flex [&_li]:gap-2 [&_li]:text-sm [&_li]:text-muted-foreground">
          ...
          <p>
            En utilisant {appName} (&ldquo;le Service&rdquo;), vous acceptez les presentes conditions.
            Si vous n&apos;acceptez pas ces conditions, ne pas utiliser le Service.
          </p>

          <h2>1. Description du service</h2>
          <p>
            {appName} est une plateforme web offrant des fonctionnalites de prise de rendez-vous,
            de gestion d&apos;abonnements et d&apos;acces API. Le Service est fourni &ldquo;tel quel&rdquo;
            avec les fonctionnalites disponibles au moment de votre souscription.
          </p>

          <h2>2. Compte utilisateur</h2>
          <ul>
            <li><span>Vous devez fournir des informations exactes lors de la creation de votre compte</span></li>
            <li><span>Vous etes responsable de la confidentialite de vos identifiants</span></li>
            <li><span>Vous devez nous notifier immediatement de toute utilisation non autorisee de votre compte</span></li>
          ...
          <ul>
            ...
            <li><span>Diffuser des contenus illicites, menacants ou diffamatoires</span></li>
          ...
          <p>
            ...
            Les tarifs sont en USD et peuvent changer avec un preavis de 30 jours.
            Aucun remboursement pour les periodes partiellement utilisees, sauf obligation legale.
          </p>
          <p>
            En cas de non-paiement, le compte est suspendu apres une periode de grace de 7 jours.
            Les donnees sont conservees 30 jours apres suspension avant suppression definitive.
          </p>

          <h2>5. Propriete intellectuelle</h2>
          <p>
            Le Service, son code, son design et son contenu sont la propriete de {appName}.
            Votre utilisation du Service ne vous confere aucun droit de propriete sur ces elements.
          </p>
          <p>
            Vous conservez la propriete integrale de vos donnees (reservations, clients, contenu).
            En cas de fermeture de compte, vous pouvez exporter vos donnees dans les 30 jours.
          </p>

          <h2>6. Cles API</h2>
          <p>
            Vos cles API sont strictement personnelles. Vous etes responsable de tout usage
            effectue avec vos cles, qu&apos;il soit autorise ou non.
            Toute cle compromise doit etre revoquee immediatement depuis le dashboard.
          </p>

          <h2>7. Disponibilite et maintenance</h2>
          <p>
            Nous visons une disponibilite de 99,9 % mais ne garantissons pas un acces ininterrompu.
            Des maintenances planifiees sont annoncees 48 heures a l&apos;avance par email.
          ...
          <p>
            ...
            payes dans les 12 mois precedant l&apos;evenement.
          </p>

          <h2>9. Resiliation</h2>
          <p>
            Vous pouvez resilier votre compte a tout moment depuis les parametres ou en nous
            contactant. Nous nous reservons le droit de suspendre ou fermer des comptes en
